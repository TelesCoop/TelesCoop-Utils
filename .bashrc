...
##############################
# prompt from https://gist.github.com/miki725/9783474
# added git dirty parsing, removed mercurial references
...
function set_git_branch() {
  ...
  branch=$(parse_git_branch)$(parse_git_dirty)
...
function set_bash_prompt () {
  ...
  PS1="
${PYTHON_VIRTUALENV}${GREEN}\u@\h${COLOR_NONE}:${BLUE}\w${COLOR_NONE}${BRANCH}
${PROMPT_SYMBOL} "
}
...
#######################
# TELESCOOP USEFUL
export TELESCOOP_DEV=1
alias open='xdg-open'  # for linux platforms
